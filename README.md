...
<head>
  ...
  <title>Inclusion policies</title>
  <style>
    body {
      margin: 0;
    ...
    h1 {
      ...
      letter-spacing: 4px;
      background: linear-gradient(90deg, #00fe2a, #4facfe);
    ...
    .row {
      ...
      border: 2px solid rgba(34, 255, 0, 0.746);
      border-radius: 12px;
      margin-bottom: 20px;
      padding: 15px;
      box-shadow: 0 0 15px rgba(13, 255, 0, 0.854));
    }
    .cell {
      font-size: 1.6em;
      font-weight: bold;
      color: #00fe26;
      text-shadow: 0 0 15px rgba(0, 255, 51, 0.7);
      margin-bottom: 15px;
      text-align: center;
    }
    .sub-row {
...
<body>
  ...
  <div class="table-container">
    ...
    <!-- Puedes seguir igual con Opportunity, Unity y Diversity -->
  </div>
</body>
</html>
